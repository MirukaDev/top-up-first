    ...
    <div class="text-center px-4">
        <div class="mb-8">
            <div class="w-32 h-32 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-6">
                <i class="fas fa-ghost text-6xl text-primary-light"></i>
            </div>
            <h1 class="text-6xl md:text-8xl font-bold text-white mb-4">404</h1>
            <h2 class="text-2xl md:text-3xl font-semibold text-white mb-4">Halaman Tidak Ditemukan</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="javascript:history.back()" class="bg-dark-light hover:bg-dark border border-primary/30 text-white px-8 py-3 rounded-xl font-semibold transition-colors inline-flex items-center justify-center">
